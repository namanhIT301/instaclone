          ...
          <div className="md:px-10 space-y-4">
            ...
            <div className="flex items-center gap-x-7">
              <p className="font-medium">
                <strong>{profile.posts.length}</strong> bài viết
              </p>
              ...
              >
                <strong>{profile.followedBy.length}</strong> người theo dõi
              </Link>
              ...
              <Link
                ...
                className="font-medium"
              >
                Đang theo dõi <strong>{profile.following.length}</strong> người dùng
              </Link>
            </div>
