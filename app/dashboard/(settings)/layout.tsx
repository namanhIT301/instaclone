...
const tabs = [
  { title: "Chỉnh sửa trang cá nhân", value: "edit-profile" },
  { title: "Tài khoản chuyên nghiệp", value: "professional-account" },
  { title: "Thông báo", value: "notifications" },
  { title: "Trung tâm quyền riêng tư", value: "privacy-and-security" },
  { title: "Hoạt động đăng nhập", value: "login-activity" },
  { title: "Emails từ Instagram", value: "emails-from-instagram" },
];
...
function SettingsLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex">
      ...
      >
        <h4 className="font-extrabold text-xl text-white ml-1">Chỉnh sửa</h4>
